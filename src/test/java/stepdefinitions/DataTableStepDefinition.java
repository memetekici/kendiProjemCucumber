...
public class DataTableStepDefinition {
    ...
    dataTablePage.firstName.sendKeys("mehmet");
    }
    @When("user enters the lastname")
    public void user_enters_the_lastname() {
    dataTablePage.lastName.sendKeys("ekici");
    ...
    dataTablePage.office.sendKeys("Berlin");
    ...
    dataTablePage.salary.sendKeys("100000");
    }
    ...
    dataTablePage.searchBox.sendKeys("mehmet");
    ...
    public void verify_the_name_fields_contains_first_name() throws InterruptedException {
        Thread.sleep(3000);
        Assert.assertTrue(dataTablePage.nameField.getText().contains("mehmet"));
    }
